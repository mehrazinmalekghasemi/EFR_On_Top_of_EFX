...
replay inputs, with proof generation and internal proof checking enabled. There
are 53 distinct regions because the four-source region is replayed twice.
Portable inputs and SHA-256 hashes are generated by verify_two_source.py.
